...
const GamepageLight = ({isDarks,setisDarks}) => {
  ...
  return (
    <div className='flex  w-[100vw] h-screen overflow-hidden bg-[var(--white)] relative'>
        {/* side navigation */}
        ...
        <div className='right w-[100vw]  max-h-screen px-[20px] relative z-[100] overflow-hidden'>
          ...
          {/* the main game field */}
          <div className='w-full h-[80%] mt-[20px] bg-[var(--white)] rounded-[10px] p-[20px] shadow-lg relative'>
            {/* the score page*/}
            {/* the score page*/}
            <div className='flex h-full w-full flex-col m-0 justify-center items-center'>
              
              <p className='text-xl font-bold'>You score</p>
              <h2 className='text-[100px] leading-none font-bold'>{score*10}%</h2>
              <p className='text-xl font-bold'>{remark}</p>
              ...
              <div className="flex w-full justify-center items-center gap-[20px]">
                <div className="left flex flex-col  gap-[15px] justify-center items-center">
                  ...
                  <p className='text-3xl font-bold text-center'>{count-1}</p>
                ...
                <h2 className='text-3xl font-bold text-center'>{score}</h2>
          ...
          {CountriesCapitalEasyObj.slice(start,end).map((e)=>{
            ...
            return(
              <div className='w-full h-full top-0 left-0 absolute bg-[var(--white)] p-[20px] shadow-md rounded-[10px] ' >
                <h3 className='text-2xl font-bold text-center mt-[30px]'>{count}/10: What is the capital of {e.name}?</h3>
                <div className='flex flex-wrap gap-10 justify-center items-center mt-[40px]'>
                  {e.options.map((options)=>{
                   
                    return <button className='w-[40%] border-[1px] border-[var(--primaryBg)] hover:bg-[var(--secondBg)] hover:text-[var(--white)] transition-all ease duration-1000  p-[15px]' onClick={()=>{
                      // logic for choices
                  ...
                  <div className='absolute bottom-0 left-0 '>
                    <p className='text-center text-xl font-bold leading-0'>score</p>
